...
With the help of [https://html5up.net/](https://html5up.net/), I'm fine tuning my personal portfolio website.
...
- [ ] Customize the template to you 
	...
	- [ ] Create finish the portfolio page
		- [x] portfolio page initialize
		- [x] content filling
		- [x] connect messaging system
		- [x] Back end response system of "Get In Touch" section
		- [ ] fine tuning
...
- [ ] Host your website for the world to see. Follow the instructions found here [https://pages.github.com/](https://pages.github.com/).  Once you have hosted your web page, share it for your peers to see.  This is not a small feat!
	* host the resume
	* host the files attached in the website:
		- [x] dsc 104 project result
		- [x] resume
		- [ ] embellish the RNN text prediction repo
